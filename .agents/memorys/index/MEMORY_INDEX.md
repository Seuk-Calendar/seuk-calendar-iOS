...
|---|---|---|---|
| 2026-03-19 | `entries/2026-03-19-widget-target-before-designsystem.md` | 유사한 날짜 셀 이름이 있을 때 디자인시스템이 아니라 실제 타깃 모듈 경로를 먼저 확인해야 하는 사례 | workflow:widget, workflow:designsystem, action:verify-target-module-before-edit, failure:edited-similar-component-in-wrong-module |
